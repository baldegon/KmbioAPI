    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Convertibilidades", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CapitalTotal = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Capitales", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Currency = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Descripcion = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FrecuenciaKind = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipoDeInversion = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UsuarioId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CapitaleId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1571373e-a8e4-41d5-bb4e-cd9f376c9f7f", "1571373e-a8e4-41d5-bb4e-cd9f376c9f7f", "Admin", "ADMIN" },
                    { "8a55199e-ab7d-4c51-906e-d2ac89dca0a1", "8a55199e-ab7d-4c51-906e-d2ac89dca0a1", "Client", "CLIENT" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GastosRecurrentes_MetodoDePagoId",
                table: "GastosRecurrentes",
                column: "MetodoDePagoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Recomendaciones_PresupuestoId",
                table: "Recomendaciones",
